...
class CommentsTableViewController: UITableViewController {
    ...
    init?(selectedPost: Post, coder: NSCoder) {
    ...
    override func viewDidLoad() {
        ...
        postBodyLabel.text = selectedPost.body
        initializeComments()
    }
    
    func initializeComments() {
        Task {
            comments = try await APIController.shared.getComments(for: selectedPost)
    ...
    override func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        content.text = comments[indexPath.row].userName
